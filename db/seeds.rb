...
bike = Bike.new(name: "Bike1", user_id: users[0].id, price: 1, description: "Size:29inch,Color:Red,Battery:100Km", category: "City", location: "Cologne")
...
bike.save
bike = Bike.new(name: "Bike2", user_id: users[1].id, price: 2, description: "Size:27inch,Color:Black,Battery:70Km", category: "City", location: "Berlin")
file = File.open(File.join(Rails.root, "app/assets/images/bike2.jpg"))
bike.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
bike.save
bike = Bike.new(name: "Bike3", user_id: users[2].id, price: 1, description: "Size:28inch,Color:Blue,Brakes:Disc", category: "City", location: "Cologne")
file = File.open(File.join(Rails.root, "app/assets/images/bike3.jpg"))
bike.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
bike.save
bike = Bike.new(name: "Bike4", user_id: users[3].id, price: 2, description: "Size:27inch,Color:White,Battery:50Km", category: "City", location: "Frankfurt")
file = File.open(File.join(Rails.root, "app/assets/images/bike4.jpg"))
bike.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
bike.save
bike = Bike.new(name: "Bike5", user_id: users[4].id, price: 1, description: "Size:29inch,Color:Yellow,Battery:45Km", category: "City", location: "Bonn")
file = File.open(File.join(Rails.root, "app/assets/images/bike5.jpg"))
bike.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
bike.save
bike = Bike.new(name: "Bike6", user_id: users[5].id, price: 2, description: "Size:27inch,Color:White,Brakes:Hydraulic", category: "City", location: "Berlin")
file = File.open(File.join(Rails.root, "app/assets/images/bike6.jpg"))
bike.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
bike.save
bike = Bike.new(name: "Bike7", user_id: users[6].id, price: 1, description: "Size:27inch,Color:Blue,Battery:30Km", category: "City", location: "Essen")
